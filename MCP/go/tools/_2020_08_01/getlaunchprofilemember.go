...
func GetlaunchprofilememberHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLaunchProfileMemberResponse
...
func CreateGetlaunchprofilememberTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_2020-08-01_studios_studioId_launch-profiles_launchProfileId_membership_principalId",
		mcp.WithDescription("Get a user persona in launch profile membership."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetlaunchprofilememberHandler(cfg),
	}
}
