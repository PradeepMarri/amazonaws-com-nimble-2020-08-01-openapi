...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_2020-08-01_tags_resourceArn",
		mcp.WithDescription("Creates tags for a resource, given its ARN."),
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description("The Amazon Resource Name (ARN) of the resource you want to add tags to. ")),
