...
func GetstudiocomponentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetStudioComponentResponse
...
func CreateGetstudiocomponentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_2020-08-01_studios_studioId_studio-components_studioComponentId",
		mcp.WithDescription("Gets a studio component resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetstudiocomponentHandler(cfg),
	}
}
