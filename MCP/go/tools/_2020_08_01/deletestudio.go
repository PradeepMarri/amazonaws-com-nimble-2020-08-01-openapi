...
func DeletestudioHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteStudioResponse
...
func CreateDeletestudioTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_2020-08-01_studios_studioId",
		mcp.WithDescription("Delete a studio resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletestudioHandler(cfg),
	}
}
