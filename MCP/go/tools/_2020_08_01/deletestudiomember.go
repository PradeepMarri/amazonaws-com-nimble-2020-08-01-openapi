...
func DeletestudiomemberHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteStudioMemberResponse
...
func CreateDeletestudiomemberTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_2020-08-01_studios_studioId_membership_principalId",
		mcp.WithDescription("Delete a user from studio membership."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletestudiomemberHandler(cfg),
	}
}
