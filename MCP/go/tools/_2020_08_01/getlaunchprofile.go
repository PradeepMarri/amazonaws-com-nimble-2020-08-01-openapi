...
func GetlaunchprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLaunchProfileResponse
...
func CreateGetlaunchprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_2020-08-01_studios_studioId_launch-profiles_launchProfileId",
		mcp.WithDescription("Get a launch profile."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetlaunchprofileHandler(cfg),
	}
}
