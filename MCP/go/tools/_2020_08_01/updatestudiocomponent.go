...
func UpdatestudiocomponentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateStudioComponentResponse
...
func CreateUpdatestudiocomponentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_2020-08-01_studios_studioId_studio-components_studioComponentId",
		mcp.WithDescription("Updates a studio component resource."),
		...
		mcp.WithString("type", mcp.Description("Input parameter: The type of the studio component.")),
		...
		mcp.WithString("name", mcp.Description("Input parameter: The name for the studio component.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatestudiocomponentHandler(cfg),
	}
}
