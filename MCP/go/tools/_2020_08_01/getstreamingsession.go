...
func GetstreamingsessionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetStreamingSessionResponse
...
func CreateGetstreamingsessionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_2020-08-01_studios_studioId_streaming-sessions_sessionId",
		mcp.WithDescription("<p>Gets StreamingSession resource.</p> <p>Invoke this operation to poll for a streaming session state while creating or deleting a session.</p>"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetstreamingsessionHandler(cfg),
	}
}
