...
func DeletelaunchprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteLaunchProfileResponse
...
func CreateDeletelaunchprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_2020-08-01_studios_studioId_launch-profiles_launchProfileId",
		mcp.WithDescription("Permanently delete a launch profile."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletelaunchprofileHandler(cfg),
	}
}
