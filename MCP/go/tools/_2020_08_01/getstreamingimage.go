...
func GetstreamingimageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetStreamingImageResponse
...
func CreateGetstreamingimageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_2020-08-01_studios_studioId_streaming-images_streamingImageId",
		mcp.WithDescription("Get streaming image."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetstreamingimageHandler(cfg),
	}
}
