...
func DeletelaunchprofilememberHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteLaunchProfileMemberResponse
...
func CreateDeletelaunchprofilememberTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_2020-08-01_studios_studioId_launch-profiles_launchProfileId_membership_principalId",
		mcp.WithDescription("Delete a user from launch profile membership."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletelaunchprofilememberHandler(cfg),
	}
}
