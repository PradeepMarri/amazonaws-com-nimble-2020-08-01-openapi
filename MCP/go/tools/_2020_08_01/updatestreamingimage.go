...
func UpdatestreamingimageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateStreamingImageResponse
...
func CreateUpdatestreamingimageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_2020-08-01_studios_studioId_streaming-images_streamingImageId",
		mcp.WithDescription("Update streaming image."),
		...
		mcp.WithString("name", mcp.Description("Input parameter: A friendly name for a streaming image resource.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatestreamingimageHandler(cfg),
	}
}
